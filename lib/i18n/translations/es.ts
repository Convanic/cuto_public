...
export const es: TranslationKeys = {
  ...
  partners: {
    ...
    types: {
      ...
      referral: {
        name: 'Socio de referencia',
        description: 'Recomienda CUTO a tu red y gana comisiones atractivas por cada contrato exitoso.',
      },
      reseller: {
      ...
      solution: {
        ...
        description: 'Asociación estratégica para grandes consultoras con actividades go-to-market conjuntas y co-selling.',
      },
      technology: {
        name: 'Socio tecnológico',
        description: 'Integra tu solución con CUTO y explora juntos nuevos mercados a través de sinergias tecnológicas.',
      },
    },
    tiers: {
    ...
    benefits: {
      title: '¿Por qué convertirse en socio de CUTO?',
    },
    testimonials: {
    ...
    cta: {
      title: '¿Listo para convertirte en socio?',
      subtitle: 'Comienza hoy y benefíciate del creciente mercado de transformación SAP. El registro solo toma 5 minutos.',
      apply: 'Solicitar como socio',
      consultation: 'Reservar consulta',
    },
    apply: {
      title: 'Solicitud de socio',
      subtitle: 'Completa el formulario para solicitar ser socio de CUTO. El procesamiento suele tardar 1-2 días hábiles.',
      steps: {
        type: 'Tipo de socio',
        contact: 'Contacto',
        company: 'Empresa',
      ...
      success: {
        ...
        message: 'Hemos recibido tu solicitud y te contactaremos en 2 días hábiles.',
      },
    },
  },
  ...
  docs: {
    title: 'Documentación',
    subtitle: 'Todo lo que necesitas saber para usar CUTO con éxito. Guías, tutoriales y mejores prácticas.',
    ...
    notFound: {
      ...
      subtitle: 'Nuestro equipo de soporte está aquí para ayudarte. Contáctanos para asistencia personalizada.',
      contactSupport: 'Contactar soporte',
    },
    feedback: {
      title: '¿Te fue útil este artículo?',
      subtitle: 'Cuéntanos cómo podemos mejorar nuestra documentación.',
      helpful: 'Sí, útil',
      notHelpful: 'No útil',
    },
  ...
  features: {
    ...
    bpmn: {
      ...
      subtitle: 'Documenta tus procesos de negocio visualmente con nuestro editor BPMN 2.0 integrado.',
    ...
    cutover: {
      ...
      subtitle: 'Planifica, ensaya y ejecuta tu go-live con precisión.',
    ...
    risks: {
      ...
      subtitle: 'Identifica, evalúa y mitiga riesgos antes de que impacten tu proyecto.',
    ...
    resources: {
      ...
      subtitle: 'Optimiza la asignación de tu equipo y asegúrate de que las personas adecuadas trabajen en las tareas correctas.',
