...
export const es: TranslationKeys = {
  ...
  compare: {
    ...
    categories: {
      ...
      sapSpecific: 'Específico de SAP',
      collaboration: 'Colaboración',
      reporting: 'Informes y análisis',
      integrations: 'Integraciones',
      pricingLicensing: 'Precios y licencias',
    },
    support: {
      full: 'Completo',
      partial: 'Parcial',
      none: 'No disponible',
      addon: 'Complemento/Extra',
    },
    featureNames: {
      ...
      'milestones': 'Hitos',
      'sap-activate': 'Plantillas SAP Activate',
      'cutover-management': 'Gestión de cutover',
      'data-migration': 'Seguimiento de migración de datos',
      'bpmn-editor': 'Editor BPMN 2.0',
      'go-live-checklist': 'Listas de verificación Go-Live',
      'hypercare': 'Gestión Hypercare',
      'transport-tracking': 'Seguimiento de transportes',
      'comments': 'Comentarios y discusiones',
      'mentions': '@-Menciones',
      'notifications': 'Notificaciones',
      'file-sharing': 'Adjuntos de archivos',
      'real-time': 'Colaboración en tiempo real',
      ...
      'export-ppt': 'Exportar a PowerPoint',
      'risk-reports': 'Informes de riesgos',
      ...
      'per-user': 'Licencia por usuario',
      'unlimited-projects': 'Proyectos ilimitados',
      'on-premise': 'Opción On-Premise',
      'data-residency': 'Almacenamiento de datos UE',
    },
    products: {
      cuto: {
        tagline: 'Diseñado para proyectos SAP',
        description: 'Solución desarrollada específicamente para la gestión de proyectos SAP con plantillas preconfiguradas y gestión de cutover.',
        pricing: 'Desde 49€/mes',
        targetAudience: 'Equipos de proyectos SAP, consultores, integradores de sistemas',
        strengths: [
          'Plantillas específicas de SAP (Activate, etc.)',
          'Gestión de cutover integrada',
          'Editor de procesos BPMN 2.0',
          'Seguimiento de migración de datos',
          'Configuración fácil',
        ],
        weaknesses: [
          'Enfoque en proyectos SAP',
          'Producto más nuevo en el mercado',
        ],
      },
      jira: {
        tagline: 'Gestión de proyectos ágil',
        description: 'Herramienta ampliamente utilizada para la gestión de proyectos ágiles, originalmente diseñada para el desarrollo de software.',
        pricing: 'Desde $7.75/usuario/mes',
        targetAudience: 'Equipos de desarrollo de software, departamentos de TI',
        strengths: [
          'Gran comunidad y marketplace',
          'Flujos de trabajo flexibles',
          'Integración DevOps sólida',
          'API extensa',
        ],
        weaknesses: [
          'Sin características específicas de SAP',
          'Configuración compleja requerida',
          'Puede ser abrumador',
          'Sin gestión de cutover',
        ],
      },
      sapAlm: {
        tagline: 'Gestión del ciclo de vida de aplicaciones SAP',
        description: 'Solución oficial de SAP para la gestión del ciclo de vida de aplicaciones y la implementación de proyectos.',
        pricing: 'Incluido con soporte SAP Enterprise',
        targetAudience: 'Clientes SAP con soporte Enterprise',
        strengths: [
          'Integración SAP nativa',
          'Parte del ecosistema SAP',
          'Incluido con soporte Enterprise',
          'Mejores prácticas SAP',
        ],
        weaknesses: [
          'Curva de aprendizaje pronunciada',
          'Flexibilidad limitada',
          'Solo para el entorno SAP',
