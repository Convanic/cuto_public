...
export const fr: TranslationKeys = {
  ...
  partners: {
    ...
    types: {
      ...
      subtitle: 'Freelance ou grande entreprise – nous avons le programme adapté pour vous.',
      referral: {
        name: 'Partenaire de référencement',
        description: 'Recommandez CUTO à votre réseau et gagnez des commissions attractives pour chaque contrat réussi.',
      },
      reseller: {
        name: 'Partenaire revendeur',
        description: 'Vendez CUTO dans votre portefeuille et bénéficiez de marges attractives et de revenus récurrents.',
      },
      solution: {
        name: 'Partenaire solution',
        description: 'Partenariat stratégique pour les grands cabinets de conseil avec des activités go-to-market communes et du co-selling.',
      },
      technology: {
        name: 'Partenaire technologique',
        description: 'Intégrez votre solution avec CUTO et explorez ensemble de nouveaux marchés grâce aux synergies technologiques.',
      },
    },
    tiers: {
      title: 'Niveaux de partenariat',
      subtitle: 'Plus vous vendez, plus vous en profitez. Montez en niveau et profitez d\'avantages supplémentaires.',
    },
    benefits: {
    ...
    cta: {
      ...
      apply: 'Postuler comme partenaire',
      consultation: 'Réserver une consultation',
    },
    apply: {
      title: 'Candidature partenaire',
      subtitle: 'Remplissez le formulaire pour postuler comme partenaire CUTO. Le traitement prend généralement 1-2 jours ouvrables.',
      steps: {
      ...
      success: {
        ...
        message: 'Nous avons reçu votre candidature et vous contacterons dans les 2 jours ouvrables.',
      },
    },
  },
  ...
  docs: {
    title: 'Documentation',
    subtitle: 'Tout ce que vous devez savoir pour utiliser CUTO avec succès. Guides, tutoriels et bonnes pratiques.',
    ...
    notFound: {
      ...
      subtitle: 'Notre équipe support est là pour vous aider. Contactez-nous pour une assistance personnalisée.',
      contactSupport: 'Contacter le support',
    },
    feedback: {
      title: 'Cet article vous a-t-il été utile ?',
      subtitle: 'Dites-nous comment nous pouvons améliorer notre documentation.',
      helpful: 'Oui, utile',
  ...
  features: {
    ...
    // Simplified versions for BPMN, Migration, Cutover, Risks, Resources
    bpmn: {
      badge: 'BPMN 2.0 conforme',
      title: 'Éditeur de processus BPMN',
      subtitle: 'Documentez vos processus métier visuellement avec notre éditeur BPMN 2.0 intégré.',
    ...
    cutover: {
      ...
      subtitle: 'Planifiez, répétez et exécutez votre go-live avec précision.',
    ...
    risks: {
      ...
      subtitle: 'Identifiez, évaluez et atténuez les risques avant qu\'ils n\'impactent votre projet.',
    ...
    resources: {
      ...
      subtitle: 'Optimisez l\'allocation de votre équipe et assurez-vous que les bonnes personnes travaillent sur les bonnes tâches.',
