...
export const fr: TranslationKeys = {
  ...
  compare: {
    ...
    categories: {
      ...
      sapSpecific: 'Spécifique SAP',
      collaboration: 'Collaboration',
      reporting: 'Rapports et analyses',
      integrations: 'Intégrations',
      pricingLicensing: 'Tarification et licences',
    },
    support: {
      full: 'Complet',
      partial: 'Partiel',
    ...
    featureNames: {
      ...
      'milestones': 'Jalons',
      'sap-activate': 'Modèles SAP Activate',
      'cutover-management': 'Gestion du cutover',
      'data-migration': 'Suivi de migration de données',
      'bpmn-editor': 'Éditeur BPMN 2.0',
      'go-live-checklist': 'Listes de contrôle Go-Live',
      'hypercare': 'Gestion Hypercare',
      'transport-tracking': 'Suivi des transports',
      'comments': 'Commentaires et discussions',
      'mentions': '@-Mentions',
      'notifications': 'Notifications',
      'file-sharing': 'Pièces jointes',
      ...
      'risk-reports': 'Rapports de risques',
      'ms-teams': 'Microsoft Teams',
      'slack': 'Slack',
      'sap-integration': 'Systèmes SAP',
      'jira-sync': 'Synchronisation Jira',
      'api': 'API REST',
      'sso': 'Authentification unique (SSO)',
      'free-tier': 'Version gratuite',
      'per-user': 'Licence par utilisateur',
      'unlimited-projects': 'Projets illimités',
      'on-premise': 'Option On-Premise',
      'data-residency': 'Stockage de données UE',
    },
    products: {
      cuto: {
        tagline: 'Conçu pour les projets SAP',
        description: 'Solution spécialement développée pour la gestion de projets SAP avec des modèles préconfigurés et la gestion du cutover.',
        pricing: 'À partir de 49€/mois',
        targetAudience: 'Équipes de projets SAP, consultants, intégrateurs système',
        strengths: [
          'Modèles spécifiques SAP (Activate, etc.)',
          'Gestion du cutover intégrée',
          'Éditeur de processus BPMN 2.0',
          'Suivi de migration de données',
          'Configuration facile',
        ],
        weaknesses: [
          'Focus sur les projets SAP',
          'Produit plus récent sur le marché',
        ],
      },
      jira: {
        tagline: 'Gestion de projet agile',
        description: 'Outil largement utilisé pour la gestion de projet agile, initialement conçu pour le développement logiciel.',
        pricing: 'À partir de 7,75$/utilisateur/mois',
        targetAudience: 'Équipes de développement logiciel, départements IT',
        strengths: [
          'Grande communauté et marketplace',
          'Workflows flexibles',
          'Intégration DevOps solide',
          'API étendue',
        ],
        weaknesses: [
          'Aucune fonctionnalité spécifique SAP',
          'Configuration complexe requise',
          'Peut être accablant',
          'Pas de gestion du cutover',
        ],
      },
      sapAlm: {
        tagline: 'Gestion du cycle de vie des applications SAP',
        description: 'Solution officielle SAP pour la gestion du cycle de vie des applications et l\'implémentation de projets.',
        pricing: 'Inclus avec le support SAP Enterprise',
        targetAudience: 'Clients SAP avec support Enterprise',
        strengths: [
          'Intégration SAP native',
          'Partie de l\'écosystème SAP',
          'Inclus avec le support Enterprise',
          'Meilleures pratiques SAP',
        ],
        weaknesses: [
          'Courbe d\'apprentissage abrupte',
          'Flexibilité limitée',
          'Uniquement pour le paysage SAP',
