...
export const it: TranslationKeys = {
  ...
  home: {
    ...
    newsletter: {
      ...
      checklistItems: [
        'Criteri di valutazione pre-progetto',
        'Checklist di preparazione al go-live',
        'Framework di identificazione rischi',
        'Template di pianificazione cutover',
      ],
      checklistCount: 'Elementi della checklist',
      successMessage: '🎉 Grazie! Controlla la tua email per la checklist progetto SAP.',
      errorMessage: 'Per favore inserisci il tuo indirizzo email.',
      sending: 'Invio in corso...',
      checkEmail: '✓ Controlla la tua email!',
      footerTitle: 'Resta aggiornato',
      footerSubtitle: 'Ricevi consigli SAP e aggiornamenti CUTO.',
      footerPlaceholder: 'La tua email',
      subscribing: 'Iscrizione...',
      subscribed: '✓ Iscritto!',
      subscribe: 'Iscriviti',
      compactTitle: 'Consigli progetto SAP',
      compactSubtitle: 'Approfondimenti settimanali per progetti SAP di successo.',
    },
    explainerVideo: {
  ...
  partners: {
    ...
    types: {
      referral: {
        ...
        shortName: 'Referral',
        description: 'Raccomanda CUTO alla tua rete e guadagna commissioni attraenti per ogni affare concluso con successo.',
        targetAudience: 'Freelancer SAP, consulenti indipendenti, project manager',
        idealFor: [
          'Consulenti SAP con una vasta rete di clienti',
          'Freelancer nella community SAP',
          'Ex dipendenti SAP',
          'Project manager con contatti in grandi aziende',
        ],
        requirements: [
          'Nessun requisito minimo',
          'Registrazione online semplice',
          'Comprensione base dei progetti SAP',
        ],
        benefits: [
          '20% di commissione sul fatturato del primo anno',
          '10% di revenue share ricorrente (Anno 2+)',
          'Link di tracking personale',
          'Pagamenti mensili',
          'Accesso al portale partner',
          'Materiali di marketing co-branded',
        ],
        commission: {
          firstYear: '20%',
          recurring: '10%',
          bonus: 'Bonus di €1.000 da 3 affari/trimestre',
        },
      },
      reseller: {
        name: 'Reseller Partner',
        shortName: 'Reseller',
        description: 'Vendi CUTO come parte del tuo portafoglio e beneficia di margini attraenti e entrate ricorrenti.',
        targetAudience: 'Piccole e medie aziende di consulenza SAP',
        idealFor: [
          'Consulenze SAP con 5-50 consulenti',
          'System integrator IT con focus SAP',
          'Fornitori di servizi SAP regionali',
          'Consulenze boutique per il mercato medio',
        ],
        requirements: [
          'Almeno 2 consulenti CUTO certificati',
          'Prova di esperienza in progetti SAP',
          'Impegno di fatturato annuale',
          'Partecipazione all\'onboarding partner',
        ],
        benefits: [
          'Margine del 25-30% sulle licenze',
          '15% di revenue share ricorrente',
          'Registrazione affari con protezione prezzi',
          'Contratti clienti propri',
          'Opzioni white-label disponibili',
          'Supporto prioritario (< 4h di risposta)',
          'Accesso alle funzionalità beta',
        ],
        commission: {
          firstYear: '25-30%',
          recurring: '15%',
          bonus: 'Bonus registrazione affari fino a €5.000',
        },
        highlight: true,
      },
      solution: {
        ...
        shortName: 'Solution',
        description: 'Partnership strategica per grandi aziende di consulenza con attività congiunte go-to-market e co-selling.',
        targetAudience: 'Grandi aziende di consulenza SAP e system integrator',
        idealFor: [
          'Consulenze SAP di alto livello',
          'System integrator globali',
          'Big 4 consulting firms',
          'SAP Gold Partner',
        ],
        requirements: [
          'Almeno 10 consulenti CUTO certificati',
          'Esperienza comprovata in progetti S/4HANA',
          'Impegno di fatturato annuale da €100k',
          'Business plan congiunto',
          'Executive sponsorship',
        ],
        benefits: [
          'Modello revenue share individuale',
          'Co-selling con il team vendite CUTO',
          'Campagne di marketing congiunte',
          'Supporto RFP',
          'Partner manager dedicato',
          'Quarterly business reviews',
          'Accesso anticipato alle funzionalità roadmap',
          'Case study e PR congiunti',
          'Prezzi preferenziali per grandi progetti',
        ],
        commission: {
          firstYear: 'Individuale',
          recurring: 'Revenue Share',
          bonus: 'Acceleratore co-selling',
        },
      },
      technology: {
        name: 'Technology Partner',
        shortName: 'Technology',
        description: 'Integra la tua soluzione con CUTO e apri insieme nuovi mercati attraverso sinergie tecnologiche.',
        targetAudience: 'Fornitori di software nell\'ecosistema SAP',
        idealFor: [
          'Fornitori di add-on SAP',
          'Produttori di strumenti di project management',
          'Piattaforme DevOps & ALM',
          'Fornitori di dati e analytics',
        ],
        requirements: [
          'Offerta di prodotti complementari',
          'Team di integrazione tecnica',
          'Target audience condiviso',
          'Capacità di integrazione API',
        ],
        benefits: [
          'Condivisione lead bidirezionale',
          'Budget co-marketing',
          'Listing su marketplace',
          'Accesso API e supporto tecnico',
          'Webinar ed eventi congiunti',
          'Showcase di integrazione',
          'Cross-promozione nella newsletter',
        ],
        commission: {
    ...
    tierLevels: {
      ...
      silver: {
        ...
        benefits: [
          'Tutti i benefit Registered',
          '+5% di margine aggiuntivo',
          'Supporto prioritario (< 8h)',
          'Chiamate partner trimestrali',
          'Pacchetto materiali di marketing',
          'Listing nella directory partner',
        ],
      },
      gold: {
        name: 'Gold',
        ...
        benefits: [
          ...
          '+10% di margine aggiuntivo',
          'Supporto prioritario (< 4h)',
          'Partner manager dedicato',
          'Budget co-marketing (€5k/anno)',
          'Accesso alle funzionalità beta',
          'Webinar congiunti',
        ],
      },
      platinum: {
        ...
        benefits: [
          ...
          '+15% di margine aggiuntivo',
          'Supporto premium (< 2h, 24/7)',
          'Executive sponsor presso CUTO',
          'Budget co-marketing (€15k/anno)',
          'Accesso anticipato alla roadmap',
          'Comunicati stampa congiunti',
          'Eventi partner esclusivi',
          'Richieste di funzionalità personalizzate',
        ],
      },
    },
    generalBenefits: [
      {
        icon: '💰',
        title: 'Commissioni attraenti',
        description: 'Fino al 30% di margine sugli affari e revenue share ricorrenti per un reddito a lungo termine.',
      },
      {
        icon: '📈',
        title: 'Mercato in crescita',
        description: 'Il mercato della trasformazione SAP S/4HANA sta crescendo rapidamente – posizionati come esperto.',
      },
      {
        icon: '🎓',
        title: 'Certificazioni gratuite',
        description: 'Diventa consulente certificato CUTO con il nostro programma di formazione completo.',
      },
      {
        icon: '🛠️',
        title: 'Supporto vendite e marketing',
        description: 'Presentazioni pronte, case study e materiali co-branded per le tue presentazioni.',
      },
      {
        icon: '🤝',
        title: 'Supporto dedicato',
        description: 'Il tuo partner manager personale ti supporta con affari e questioni strategiche.',
      },
      {
        icon: '🚀',
        title: 'Onboarding veloce',
        description: 'In sole 2 settimane dalla domanda al partner attivo – te lo rendiamo facile.',
      },
    ],
    partnerTestimonials: [
      {
        quote: 'Come freelancer ho guadagnato oltre €45.000 in commissioni negli ultimi 12 mesi – semplicemente attraverso raccomandazioni nella mia rete. CUTO si vende praticamente da solo.',
      ...
      {
        quote: 'La partnership con CUTO ha completato perfettamente il nostro portafoglio di servizi. Ora offriamo soluzioni end-to-end per la trasformazione SAP e abbiamo aumentato il nostro fatturato del 40%.',
      ...
      {
        quote: 'Il modello di co-selling funziona in modo eccellente. Per RFP complessi lavoriamo mano nella mano con il team CUTO – questo convince i clienti e accelera il ciclo di vendita.',
    ...
    faqItems: [
      {
        question: 'Quanto velocemente posso iniziare a guadagnare?',
        answer: 'Dopo la registrazione riceverai immediatamente il tuo link di tracking personale. Non appena un cliente da te raccomandato firma un contratto e viene effettuato il primo pagamento, la tua commissione diventa dovuta. Per gli affari enterprise il ciclo di vendita può richiedere 3-6 mesi.',
      },
      {
        question: 'C\'è una durata minima del contratto?',
        answer: 'No, come Referral Partner puoi smettere in qualsiasi momento senza preavviso. Per Reseller e Solution Partner si applicano accordi individuali, tipicamente con una durata annuale.',
      },
      {
        question: 'Come funziona la registrazione degli affari?',
        answer: 'I Reseller e Solution Partner possono registrare potenziali affari tramite il portale partner. Questo ti dà protezione dei prezzi per 90 giorni e impedisce ad altri partner di lavorare sullo stesso lead.',
      },
      {
        question: 'Quale formazione è richiesta?',
        answer: 'I Referral Partner non richiedono certificazione formale. Per Reseller e Solution Partner offriamo un programma di certificazione online gratuito (circa 8 ore) oltre a formazione in presenza opzionale.',
      },
      {
        question: 'Posso diventare Reseller in seguito come freelancer?',
        answer: 'Sì, molti dei nostri partner di maggior successo hanno iniziato come Referral Partner e sono cresciuti. Una volta che soddisfi i requisiti, puoi fare upgrade e beneficiare di condizioni migliori.',
      },
      {
        question: 'Ci sono territori di vendita esclusivi?',
        answer: 'Per i Platinum Partner possiamo stipulare accordi esclusivi in determinate regioni o settori. Questo viene negoziato individualmente e richiede impegni di fatturato corrispondenti.',
      },
    ],
  },
