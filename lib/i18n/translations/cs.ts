...
export const cs: TranslationKeys = {
  ...
  home: {
    ...
    newsletter: {
      ...
      checklistItems: [
        'Kritéria hodnocení před projektem',
        'Kontrolní seznam připravenosti na go-live',
        'Rámec identifikace rizik',
        'Šablona plánování přechodu',
      ],
      checklistCount: 'Položek kontrolního seznamu',
      successMessage: '🎉 Děkujeme! Zkontrolujte svůj e-mail pro kontrolní seznam SAP projektu.',
      errorMessage: 'Zadejte prosím svou e-mailovou adresu.',
      sending: 'Odesílání...',
      checkEmail: '✓ Zkontrolujte svůj e-mail!',
      footerTitle: 'Zůstaňte informováni',
      footerSubtitle: 'Získejte tipy pro SAP projekty a novinky z CUTO.',
      footerPlaceholder: 'Váš e-mail',
      subscribing: 'Přihlašování...',
      subscribed: '✓ Přihlášeno!',
      subscribe: 'Přihlásit se',
      compactTitle: 'Tipy pro SAP projekty',
      compactSubtitle: 'Týdenní poznatky pro úspěšné SAP projekty.',
    },
    explainerVideo: {
  ...
  partners: {
    ...
    types: {
      referral: {
        ...
        shortName: 'Referral',
        description: 'Doporučte CUTO své síti a získejte atraktivní provize za každý úspěšný obchod.',
        targetAudience: 'SAP freelancery, nezávislé konzultanty, projektové manažery',
        idealFor: [
          'SAP konzultanti se širokou sítí klientů',
          'Freelanceři v SAP komunitě',
          'Bývalí zaměstnanci SAP',
          'Projektoví manažeři s kontakty ve velkých podnicích',
        ],
        requirements: [
          'Žádné minimální požadavky',
          'Jednoduchá online registrace',
          'Základní porozumění projektům SAP',
        ],
        benefits: [
          '20% provize z příjmů prvního roku',
          '10% opakující se podíl na příjmech (Rok 2+)',
          'Osobní sledovací odkaz',
          'Měsíční výplaty',
          'Přístup k partnerskému portálu',
          'Společné marketingové materiály',
        ],
        commission: {
          firstYear: '20%',
          recurring: '10%',
          bonus: 'Bonus €1.000 od 3 obchodů/čtvrtletí',
        },
      },
      reseller: {
        name: 'Reseller Partner',
        shortName: 'Reseller',
        description: 'Prodávejte CUTO jako součást svého portfolia a těžte z atraktivních marží a opakujících se příjmů.',
        targetAudience: 'Malé a střední SAP konzultační společnosti',
        idealFor: [
          'SAP konzultace s 5-50 konzultanty',
          'IT systémové domy se zaměřením na SAP',
          'Regionální poskytovatelé služeb SAP',
          'Boutique konzultace pro střední trh',
        ],
        requirements: [
          'Alespoň 2 certifikovaní konzultanti CUTO',
          'Důkaz zkušeností s projekty SAP',
          'Roční závazek příjmů',
          'Účast na partnerském onboarding',
        ],
        benefits: [
          'Marže 25-30% na licence',
          '15% opakující se podíl na příjmech',
          'Registrace obchodů s cenovou ochranou',
          'Vlastní smlouvy s klienty',
          'Dostupné možnosti white-label',
          'Prioritní podpora (< 4h odpověď)',
          'Přístup k beta funkcím',
        ],
        commission: {
          firstYear: '25-30%',
          recurring: '15%',
          bonus: 'Bonus za registraci obchodu až €5.000',
        },
        highlight: true,
      },
      solution: {
        ...
        shortName: 'Solution',
        description: 'Strategické partnerství pro velké konzultační společnosti se společnými go-to-market aktivitami a společným prodejem.',
        targetAudience: 'Velké SAP konzultační společnosti a systémoví integrátoři',
        idealFor: [
          'Top-tier SAP konzultace',
          'Globální systémoví integrátoři',
          'Big 4 konzultační firmy',
          'SAP Gold Partners',
        ],
        requirements: [
          'Alespoň 10 certifikovaných konzultantů CUTO',
          'Osvědčené zkušenosti s projekty S/4HANA',
          'Roční závazek příjmů od €100k',
          'Společný obchodní plán',
          'Výkonné sponzorství',
        ],
        benefits: [
          'Individuální model podílu na příjmech',
          'Společný prodej s prodejním týmem CUTO',
          'Společné marketingové kampaně',
          'Podpora RFP',
          'Vyhrazený partnerský manažer',
          'Čtvrtletní obchodní přehledy',
          'Předčasný přístup k funkcím roadmap',
          'Společné případové studie a PR',
          'Preferenční ceny pro velké projekty',
        ],
        commission: {
          firstYear: 'Individuální',
          recurring: 'Revenue Share',
          bonus: 'Akcelerátor společného prodeje',
        },
      },
      technology: {
        name: 'Technology Partner',
        shortName: 'Technology',
        description: 'Integrujte své řešení s CUTO a společně otevírejte nové trhy prostřednictvím technologických synergií.',
        targetAudience: 'Poskytovatelé softwaru v ekosystému SAP',
        idealFor: [
          'Poskytovatelé SAP add-onů',
          'Výrobci nástrojů pro řízení projektů',
          'Platformy DevOps & ALM',
          'Poskytovatelé dat a analytiky',
        ],
        requirements: [
          'Doplňková produktová nabídka',
          'Tým technické integrace',
          'Sdílená cílová skupina',
          'Schopnost integrace API',
        ],
        benefits: [
          'Obousměrné sdílení leadů',
          'Rozpočet společného marketingu',
          'Výpis na marketplace',
          'Přístup k API a technická podpora',
          'Společné webináře a akce',
          'Showcase integrace',
          'Cross-promoce v newsletteru',
        ],
        commission: {
    ...
    tierLevels: {
      ...
      silver: {
        ...
        benefits: [
          'Všechny výhody Registered',
          '+5% dodatečná marže',
          'Prioritní podpora (< 8h)',
          'Čtvrtletní partnerské hovory',
          'Balíček marketingových materiálů',
          'Výpis v partnerském adresáři',
        ],
      },
      gold: {
        name: 'Gold',
        ...
        benefits: [
          'Všechny výhody Silver',
          '+10% dodatečná marže',
          'Prioritní podpora (< 4h)',
          'Vyhrazený partnerský manažer',
          'Rozpočet společného marketingu (€5k/rok)',
          'Přístup k beta funkcím',
          'Společné webináře',
        ],
      },
      platinum: {
        ...
        benefits: [
          'Všechny výhody Gold',
          '+15% dodatečná marže',
          'Prémiová podpora (< 2h, 24/7)',
          'Výkonný sponzor v CUTO',
          'Rozpočet společného marketingu (€15k/rok)',
          'Předčasný přístup k roadmap',
          'Společné tiskové zprávy',
          'Exkluzivní partnerské akce',
          'Vlastní požadavky na funkce',
        ],
      },
    },
    generalBenefits: [
      {
        icon: '💰',
        title: 'Atraktivní provize',
        description: 'Až 30% marže na obchody a opakující se podíly na příjmech pro dlouhodobý příjem.',
      },
      {
        icon: '📈',
        title: 'Rostoucí trh',
        description: 'Trh transformace SAP S/4HANA rychle roste – pozicujte se jako expert.',
      },
      {
        icon: '🎓',
        title: 'Bezplatné certifikace',
        description: 'Staňte se certifikovaným konzultantem CUTO s naším komplexním školicím programem.',
      },
      {
        icon: '🛠️',
        title: 'Podpora prodeje a marketingu',
        description: 'Hotové prezentace, případové studie a společné marketingové materiály pro vaše prezentace.',
      },
      {
        icon: '🤝',
        title: 'Vyhrazená podpora',
        description: 'Váš osobní partnerský manažer vás podporuje v obchodech a strategických otázkách.',
      },
      {
        icon: '🚀',
        title: 'Rychlý onboarding',
        description: 'Za pouhé 2 týdny od žádosti k aktivnímu partnerovi – usnadníme vám to.',
      },
    ],
    partnerTestimonials: [
      {
        quote: 'Jako freelancer jsem za posledních 12 měsíců vydělal přes €45.000 na provizích – jednoduše prostřednictvím doporučení v mé síti. CUTO se prakticky prodává samo.',
      ...
      {
        quote: 'Partnerství s CUTO perfektně doplnilo naše portfolio služeb. Nyní nabízíme end-to-end řešení transformace SAP a zvýšili jsme naše příjmy o 40%.',
      ...
      {
        quote: 'Model společného prodeje funguje výborně. U složitých RFP pracujeme ruku v ruce s týmem CUTO – to přesvědčuje zákazníky a urychluje prodejní cyklus.',
    ...
    faqItems: [
      {
        question: 'Jak rychle mohu začít vydělávat?',
        answer: 'Po registraci okamžitě obdržíte svůj osobní sledovací odkaz. Jakmile zákazník, kterého jste doporučili, podepíše smlouvu a bude provedena první platba, vaše provize se stane splatnou. U enterprise obchodů může prodejní cyklus trvat 3-6 měsíců.',
      },
      {
        question: 'Existuje minimální doba trvání smlouvy?',
        answer: 'Ne, jako Referral Partner můžete kdykoli přestat bez výpovědi. Pro Reseller a Solution Partnery platí individuální dohody, obvykle s roční dobou trvání.',
      },
      {
        question: 'Jak funguje registrace obchodů?',
        answer: 'Reseller a Solution Partneři mohou registrovat potenciální obchody prostřednictvím partnerského portálu. To vám poskytne cenovou ochranu na 90 dní a zabrání ostatním partnerům pracovat na stejném leadu.',
      },
      {
        question: 'Jaké školení je vyžadováno?',
        answer: 'Referral Partneři nevyžadují formální certifikaci. Pro Reseller a Solution Partnery nabízíme bezplatný online certifikační program (přibližně 8 hodin) a také volitelné školení na místě.',
      },
      {
        question: 'Mohu se později stát Resellerem jako freelancer?',
        answer: 'Ano, mnoho našich nejúspěšnějších partnerů začalo jako Referral Partneři a rostli. Jakmile splníte požadavky, můžete upgradovat a těžit z lepších podmínek.',
      },
      {
        question: 'Existují exkluzivní prodejní území?',
        answer: 'Pro Platinum Partnery můžeme uzavřít exkluzivní dohody v určitých regionech nebo odvětvích. To se vyjednává individuálně a vyžaduje odpovídající závazky příjmů.',
      },
    ],
  },
  ...
  compare: {
    ...
    categories: {
      ...
      sapSpecific: 'SAP specifické',
      collaboration: 'Spolupráce',
      reporting: 'Reportování a analýzy',
      integrations: 'Integrace',
      pricingLicensing: 'Ceny a licencování',
    },
    support: {
      full: 'Plně',
      partial: 'Částečně',
    ...
    featureNames: {
      ...
      'kanban-board': 'Kanban tabule',
      'sprint-planning': 'Plánování sprintu',
      'resource-management': 'Řízení zdrojů',
      'time-tracking': 'Sledování času',
      'dependencies': 'Závislosti',
      'milestones': 'Míle',
      'sap-activate': 'Šablony SAP Activate',
      'cutover-management': 'Řízení cutoveru',
      'data-migration': 'Sledování migrace dat',
      'bpmn-editor': 'Editor BPMN 2.0',
      'go-live-checklist': 'Kontrolní seznamy Go-Live',
      'hypercare': 'Řízení Hypercare',
      'transport-tracking': 'Sledování transportů',
      'comments': 'Komentáře a diskuze',
      'mentions': '@-Zmínky',
      'notifications': 'Oznámení',
      'file-sharing': 'Přílohy souborů',
      'real-time': 'Spolupráce v reálném čase',
      'dashboards': 'Řídicí panely',
      'custom-reports': 'Vlastní reporty',
      'export-excel': 'Export do Excel',
      'export-pdf': 'Export do PDF',
      'export-ppt': 'Export do PowerPoint',
      'risk-reports': 'Reporty rizik',
      'ms-teams': 'Microsoft Teams',
      'slack': 'Slack',
      'sap-integration': 'SAP systémy',
      'jira-sync': 'Synchronizace s Jira',
      'api': 'REST API',
      'sso': 'Jednotné přihlášení (SSO)',
      'free-tier': 'Bezplatná verze',
      'per-user': 'Licencování na uživatele',
      'unlimited-projects': 'Neomezené projekty',
      'on-premise': 'On-Premise možnost',
      'data-residency': 'Úložiště dat v EU',
    },
    products: {
      cuto: {
        tagline: 'Vytvořeno pro SAP projekty',
        description: 'Řešení speciálně vyvinuté pro řízení SAP projektů s předkonfigurovanými šablonami a řízením cutoveru.',
        pricing: 'Od 49€/měsíc',
        targetAudience: 'SAP projektové týmy, konzultanti, systémoví integrátoři',
        strengths: [
          'SAP specifické šablony (Activate, atd.)',
          'Integrované řízení cutoveru',
          'Editor procesů BPMN 2.0',
          'Sledování migrace dat',
          'Snadné nastavení',
        ],
        weaknesses: [
          'Zaměření na SAP projekty',
          'Novější produkt na trhu',
        ],
      },
      jira: {
        tagline: 'Agilní řízení projektů',
        description: 'Široce používaný nástroj pro agilní řízení projektů, původně navržený pro vývoj software.',
        pricing: 'Od $7.75/uživatel/měsíc',
        targetAudience: 'Týmy pro vývoj software, IT oddělení',
        strengths: [
          'Velká komunita a marketplace',
          'Flexibilní pracovní postupy',
          'Silná integrace DevOps',
          'Rozsáhlé API',
        ],
        weaknesses: [
          'Žádné SAP specifické funkce',
          'Vyžaduje složitou konfiguraci',
          'Může být ohromující',
          'Žádné řízení cutoveru',
        ],
      },
      sapAlm: {
        tagline: 'SAP Application Lifecycle Management',
        description: 'Oficiální řešení SAP pro řízení životního cyklu aplikací a implementaci projektů.',
        pricing: 'Zahrnuto v SAP Enterprise Support',
        targetAudience: 'SAP zákazníci s Enterprise Support',
        strengths: [
          'Nativní integrace SAP',
          'Část SAP ekosystému',
          'Zahrnuto v Enterprise Support',
          'SAP osvědčené postupy',
        ],
        weaknesses: [
          'Strmá křivka učení',
          'Omezená flexibilita',
          'Pouze pro SAP prostředí',
